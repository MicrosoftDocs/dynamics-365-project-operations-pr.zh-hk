...
| msdyn_effortcompleted                  | 否 (對於專案則是)             | 否 (對於專案則是)               |
| msdyn_effortremaining                  | 否 (對於專案則是)              | 否 (對於專案則是)                |
...
| msdyn_progress                         | 否 (對於專案則是)             | 否 (對於專案則是) |
...
### <a name="project-bucket"></a>專案貯體

| 邏輯名稱          | 可以建立      | 可以編輯     |
|-----------------------|-----------------|--------------|
| msdyn_displayorder    | .是             | 否           |
| msdyn_name            | .是             | .是          |
| msdyn_project         | .是             | 否           |
| msdyn_projectbucketid | .是             | 否           |
