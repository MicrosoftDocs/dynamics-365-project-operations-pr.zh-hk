---
title: 佈建新的環境
description: 本文提供有關如何佈建新 Project Operations 環境的資訊。
author: sigitac
ms.date: 09/13/2021
ms.topic: article
ms.prod: ''
...
本文提供有關如何為資源/非庫存型案例佈建新的 Dynamics 365 Project Operations 環境的資訊。
...
5. 選取 **Dynamics 365 Finance 雙重寫入實體對應** 和 **Dynamics 365 Project Operations 雙重寫入實體對應** 這兩個解決方案，然後選取 **套用**。
...
3. 開始執行對應。 如需詳細資訊，請參閱 [Project Operations 雙重寫入對應版本](resource-dual-write-maps.md#project-operations-dual-write-maps)
4. 驗證所有專案相關的對應是否為執行中狀態。
