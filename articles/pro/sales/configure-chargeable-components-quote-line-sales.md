---
title: 設定專案報價明細中的應收費元件
description: 本文提供有關設定專案型報價明細中應收費和不應收費元件的資訊。
author: rumant
ms.date: 03/30/2021
ms.topic: article
...
ms.locfileid: "9825545"
---
# <a name="configure-chargeable-components-on-project-quote-lines"></a>設定專案報價明細中的應收費元件
