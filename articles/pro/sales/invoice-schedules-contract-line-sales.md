...
ms.locfileid: "4087734"
---
# <a name="creating-invoice-schedules-on-a-project-based-contract-line"></a>正在專案型合約服務內容中建立發票排程
...
合約服務內容使用固定價格帳務方式時，您可以建立基於里程碑的發票排程。 完成下列步驟，為一組在行事曆期間平均分佈的固定價格里程碑，產生基於里程碑的發票排程。
...
3. 選取 **儲存後關閉** 。
| 明細金額 | 快速建立 | 向客戶開立發票的里程碑金額或值 | 這會傳播至專案合約服務內容里程碑和發票 | | 稅金 | 快速建立 | 將套用在里程碑的稅額 | 這會傳播至專案合約服務內容里程碑和發票 |
