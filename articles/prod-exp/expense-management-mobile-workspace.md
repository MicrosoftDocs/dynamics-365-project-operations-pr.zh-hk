...
- 拍攝收據的相片，並將其上傳至 Dynamics 365 Finance。 您可以稍後再將該相片附加至費用報表。
...
## <a name="download-and-install-the-dynamics-365-for-operations-mobile-app"></a>下載並安裝 Dynamics 365 for Operations 行動應用程式
