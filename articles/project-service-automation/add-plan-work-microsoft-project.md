...
> [!IMPORTANT]
> - 若要使用 SharePoint 文件管理儲存您的 [!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)] 檔案以用於 [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)] 專案，[!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)] 系統管理員必須開啟文件管理。 [!INCLUDE[proc_more_information](../includes/proc-more-information.md)][啟用特定實體的 SharePoint 文件管理](../admin/enable-sharepoint-document-management-specific-entities.md)  
...
## <a name="read-from-a-template"></a>從範本讀取  
 從您在 [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)] 中建立並複製到 [!INCLUDE[pn_microsoft_project](../includes/pn-microsoft-project.md)] 的範本讀取，開始您的專案規劃。 [!INCLUDE[proc_more_information](../includes/proc-more-information.md)][建立專案範本 (Project Service Automation)](../project-service/create-project-template.md)  
...
## <a name="upload-a-project-file-to-sharepoint-or-office-groups"></a>將專案檔案上傳至 SharePoint 或 Office 群組  
 您可以將專案檔案上傳到 SharePoint，它會位在您的 [!INCLUDE[pn_project_service_auto](../includes/pn-project-service-auto.md)] 專案的相關聯文件底下。  您需要請系統管理員設定 SharePoint 文件管理功能，並開啟專案實體的這項功能。 [!INCLUDE[proc_more_information](../includes/proc-more-information.md)][設定 SharePoint 整合](../admin/set-up-sharepoint-integration.md)  

 如果您已設定 Office 群組，也可以將專案檔案上傳至[!INCLUDE[pn_onedrive_for_business](../includes/pn-onedrive-for-business.md)]。 [!INCLUDE[proc_more_information](../includes/proc-more-information.md)][使用 Office 365 群組與同事共同作業](../basics/collaborate-with-colleagues-using-office-365-groups.md)  
