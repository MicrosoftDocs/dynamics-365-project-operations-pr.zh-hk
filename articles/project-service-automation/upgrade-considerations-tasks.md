...
- [計畫](../developer/entities/msdyn_project.md)
- [專案團隊](../developer/entities/msdyn_projectteam.md)
- [專案工作](../developer/entities/msdyn_projecttask.md)
- [資源指派](../developer/entities/msdyn_resourceassignment.md)
- [專案工作相依性](../developer/entities/msdyn_projecttaskdependency.md)
- [可預約資源](../developer/entities/bookableresource.md)

若要定義資源已載入的分工結構圖，您必須完成下列步驟：

1. 建立新專案： 如需有關如何建立新專案的詳細資訊，請參閱 [msdyn_project](../developer/entities/msdyn_project.md)。
2. 建立一個或多個工作。 如需有關如何建立工作的詳細資訊，請參閱 [msdyn_projecttask](../developer/entities/msdyn_projecttask.md)。
3. 定義工作相依性。 如需詳細資訊，請參閱[專案工作相依性](../developer/entities/msdyn_projecttaskdependency.md)。
4. 將專案團隊成員指派給專案。 如需詳細資訊，請參閱 [msdyn_projectteam](../developer/entities/msdyn_projectteam.md)。
5. 將專案團隊成員指派給工作。 如需詳細資訊，請參閱 [msdyn_resourceassignment](../developer/entities/msdyn_resourceassignment.md)。
