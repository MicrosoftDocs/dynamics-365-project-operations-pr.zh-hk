...
正在尋找可協助規劃您的實作的資源嗎？ 請查看這些可下載的指南。
 ...
 [專案規劃和追蹤指南](../project-service/implementation-guides/project-planning-tracking.md)

 [基本報價、定價和帳務指南](../project-service/implementation-guides/begin-quoting-pricing-billing.md)

 [進階報價、定價和帳務指南](../project-service/implementation-guides/adv-quoting-pricing-billing.md)

 [資源管理員指南](../project-service/implementation-guides/resource-management-guide.md)

 [報表群組](../project-service/implementation-guides/reporting-guide.md)

 [開發人員注意事項](../project-service/developer-guides/overview-dev-notes-v3.x.md)
...
## <a name="guidance-for-earlier-versions-app-version-2x-or-1x"></a>舊版 (應用程式版本 2.x 或 1.x) 指引
 ...
 [時間、費用和共同作業](../project-service/time-expense-collaboration-guide.md)

 [白皮書 (應用程式版本 2.x 或 1.x)](../project-service/white-papers.md)

 [開發人員注意事項 (應用程式 2.x 版)](../project-service/developer-guides/add-custom-qoi-forms-v2.x.md)
