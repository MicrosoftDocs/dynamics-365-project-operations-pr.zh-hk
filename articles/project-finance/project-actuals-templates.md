...
- 如果要建立新範本，您必須新增該欄才能支援公司間的時間與費用。 選取**新增條件欄**，並輸入該欄的名稱，例如 **LegalEntity**。 輸入欄的條件，其中如果 **msdyn\_contractorganizationalunitid.msdyn\_name** 是 \<組織單位\>，則為 \<輸入法律實體\>；否則為 null。
...
[![範本對應](./media/ActualsMapping.jpg)](./media/ActualsMapping.jpg)

[![範本對應](./media/TransactionConnections.jpg)](./media/TransactionConnections.jpg)
...
[![範本對應](./media/ActualsUpdateMapping.jpg)](./media/ActualsUpdateMapping.jpg)

[![範本對應](./media/TransactionConnectionsUpdate.jpg)](./media/TransactionConnectionsUpdate.jpg)
